  ...
  const[CircularProgress1,setCircularProgress]=useState(false);
      ...
      const statesList = [
        ...
        const schema=yup.object().shape({
            ...
            .matches(
                /^[a-zA-Z0-9 ]+$/,
                "Equipment name can only contain alphabets, numbers, and spaces."
              )
              .max(35, "Equipment name must be at most 35 characters."),
            ...
            BrandName:yup
                ...
                .matches(
                  ...
                  .max(25, "Brand name must be at most 35 characters."),
...
<div className="bannerImage">
    ...
    "& .MuiFormLabel-root.Mui-focused": {
      color: errors.EquipmentName ? 'red' : '#66bb6a', // Green for label color
